...
def export_stacking():
    stk_files = [
        ("stacking_v2", "results/training/stacking_v2/oof_predictions.npz"),
        ("stacking_v2_legacy", "results/legacy/hidden_2026-05-19/top_level/weekend_experiments/stacking_optimization/oof_predictions.npz"),
        ("stacking_v1_backup", "results/legacy/hidden_2026-05-19/top_level/weekend_experiments/stacking_optimization/_backup_v1_cpan70/oof_predictions.npz"),
    ]
