...
STRINGS = {
    "ko": {
        ...
        "mode_balanced": "균형",
        "mode_balanced_desc": "민감도/특이도 균형 (Youden's J 최적점)",
        ...
        "confirm_analysis": "환자 {patient_id}의 스펙트럼 {n}개를 {mode} 모드로 분석하시겠습니까?",
        ...
        "disclaimer": "본 결과는 선별검사 목적이며, 최종 진단은 임상 전문의의 판단에 따릅니다.",
    ...
    "en": {
        ...
        "mode_title": "Select Operating Mode",
        ...
        "confirm_analysis": "Analyze {n} spectra for patient {patient_id} in {mode} mode?",
        ...
        "disclaimer": "This result is for screening purposes only. Final diagnosis should be made by a clinical specialist.",
