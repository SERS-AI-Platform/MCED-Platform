...
STRINGS = {
    "ko": {
        ...
        "risk_moderate": "중간",
        "risk_high": "높음",
        "risk_band_guide_title": "SSI 구간별 의미",
        ...
        "risk_low_interpretation": "암 관련 신호가 낮은 구간입니다. 암 배제를 의미하지 않으며, 증상 및 다른 검사 결과와 함께 해석합니다.",
        "risk_moderate_interpretation": "암 관련 신호가 경계 수준입니다. 단독 판단은 어렵고, 추가 검토가 필요합니다.",
        "risk_high_interpretation": "암 관련 신호가 높은 구간입니다. 확진 결과는 아니며, 추가 검사가 필요합니다.",
    ...
    "en": {
        ...
        "risk_high": "High",
        "risk_band_guide_title": "Meaning of Each SSI Band",
        "risk_band_guide_band": "Band",
        "risk_band_guide_meaning": "Meaning",
        "risk_low_range": "0.0 ≤ SSI < 1.0",
        "risk_moderate_range": "1.0 ≤ SSI < 4.0",
        "risk_high_range": "4.0 ≤ SSI ≤ 10.0",
        "risk_low_interpretation": "Cancer-related signal is in the low band. This does not rule out cancer; interpret it together with symptoms and other test results.",
        "risk_moderate_interpretation": "Cancer-related signal is in the boundary band. It is not sufficient for a standalone decision; further review is needed.",
        "risk_high_interpretation": "Cancer-related signal is in the high band. This is not a diagnosis; additional testing is needed.",
