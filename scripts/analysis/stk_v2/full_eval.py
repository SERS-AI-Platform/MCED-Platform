...
Inputs (existing):
  ...
  results/training/stacking_v2/base_model_contribution.csv
...
Outputs (overwritten):
  results/training/stacking_v2/analysis/experiment_summary.json
  results/training/stacking_v2/analysis/peak_interpretation.json
"""
