"""
AACR Figure Style — Single Source of Truth for colors, labels, and styling.

All AACR figure scripts import from this module to ensure visual consistency.
"""
...
SERS_ROOT = os.path.dirname(AACR_DIR)
FIGURE_DIR = os.path.join(AACR_DIR, "figures")
DATA_DIR = os.path.join(AACR_DIR, "data")
...
def save_figure(fig, name, formats=("png", "pdf"), transparent=True):
    ...
    for fmt in formats:
        ...
        fig.savefig(path, dpi=300, facecolor=fc, edgecolor="none",
