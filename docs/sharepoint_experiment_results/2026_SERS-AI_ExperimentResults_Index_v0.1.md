...
| `PhaseW_7Cancer_HeldOut_v0.1` | 7-cancer held-out/fusion milestone | 7-cancer setting tracked in `docs/experiment.md` | Excel, ROC, confusion matrix, sensitivity/performance figures |
