...
| `docs/clinical_use/USABILITY_EVALUATION_PROTOCOL.md` | usability validation source |
| `docs/clinical_use/TRACEABILITY_MATRIX.md` | requirement/use-case traceability |
