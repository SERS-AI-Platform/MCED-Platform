...
│   │   ├── sers_webapp.py         #     FastAPI 웹앱 (파일 업로드 UI)
│   │   └── sers_api.py            #     REST API
│   │
│   ├── db/                        #   데이터베이스
...
│   ├── EXPERIMENT_CONTEXT.md      #   실험 설계/비교 규칙
│   ├── experiment.md              #   현재 실험 상태
│   ├── MODEL_WORKFLOW.md          #   모델 워크플로우
