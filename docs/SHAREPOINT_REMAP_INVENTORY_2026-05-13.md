...
- `docs/DEVELOPMENT_ASSET_GOVERNANCE.md`
...
| `docs/DEVELOPMENT_ASSET_GOVERNANCE.md` | added to Git |
...
| Local file/folder | Proposed SharePoint name | Action |
| --- | --- | --- |
| `docs/clinical_use/README.md` | `2026_SERS-AI_ClinicalUse_README.md` | upload if used for clinical-facing review |
| `docs/clinical_use/TRACEABILITY_MATRIX.md` | `2026_SERS-AI_TraceabilityMatrix_Draft.md` | upload or convert to controlled doc |
| `docs/clinical_use/USABILITY_EVALUATION_FORMS.md` | `2026_SERS-AI_UsabilityEvaluationForms_Draft.md` | upload |
| `docs/clinical_use/USABILITY_EVALUATION_PROTOCOL.md` | `2026_SERS-AI_UsabilityEvaluationProtocol_Draft.md` | upload |
| `docs/clinical_use/USER_MANUAL.md` | `2026_SERS-AI_UserManual_Draft.md` | upload |
