...
| --- | --- | --- |
| `AACR/` | `/01_Projects/SERS-AI/Conference/2026_AACR/` | Ignore in Git |
| `monthly_meeting_*.pptx` | `/06_Management_Report/Monthly_Meeting/2026/` | Ignore in Git |
| `docs/clinical_use/` | `/03_Clinical_Study/Clinical_Use/` or `/02_Regulatory_QMS/Product_Documentation/` | Keep source docs in Git only if they are technical/reproducible |
| `docs/patent/` | `/04_IP_Patent/2026_SERS-AI/` | Keep markdown strategy docs if useful; Word/PDF controlled versions go to SharePoint |
...
4. Decide whether `docs/patent/*.docx` should remain in Git or move to `/04_IP_Patent/`.
5. Decide whether `/home/insu/solum-dashboard` should become its own Git repository.
