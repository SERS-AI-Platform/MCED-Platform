...
| --- | ---: | --- |
| 5-cancer SERS-only detection AUC | 0.977 +/- 0.005 | Held-out test, `docs/ml/EXPERIMENT_CONTEXT.md` Phase P |
...
| 7-cancer fusion detection AUC | 0.979 +/- 0.005 | Phase W, `docs/ml/experiment.md` |
| 7-cancer fusion type ID F1 | 0.923 +/- 0.022 | Phase W, `docs/ml/experiment.md` |
