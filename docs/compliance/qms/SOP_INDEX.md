...
|---|---|---|---|---|---|
| SOP-QMS-001 | Document control and versioning | Document control | [DEVELOPMENT_ASSET_GOVERNANCE.md](../DEVELOPMENT_ASSET_GOVERNANCE.md), [SHAREPOINT_REMAP_INVENTORY_2026-05-13.md](../../sharepoint/SHAREPOINT_REMAP_INVENTORY_2026-05-13.md) | Draft | `/02_Regulatory_QMS/Document_Control/` |
...
| SOP-SW-004 | Clinical app deployment workflow | Software product control | `scripts/deployment/`, [sharepoint/sw_product](../../sharepoint/sw_product/) | Partial | `/02_Regulatory_QMS/Product_Documentation/` |
...
| SOP-MODEL-001 | Model training and validation | Model development control | [MODEL_WORKFLOW.md](../../architecture/MODEL_WORKFLOW.md), `scripts/training/`, `tests/` | Partial | `/02_Regulatory_QMS/Model_Development/` |
...
| SOP-CLIN-001 | Clinical app IFU and usability traceability | Requirements traceability | [clinical](../../clinical/), [sharepoint/sw_product](../../sharepoint/sw_product/) | Draft | `/02_Regulatory_QMS/Product_Documentation/` |
...
| SOP-RISK-001 | Software risk management | Risk management | [clinical/TRACEABILITY_MATRIX.md](../../clinical/TRACEABILITY_MATRIX.md), terminology restrictions | Open gate | `/02_Regulatory_QMS/Risk_Management/` |
