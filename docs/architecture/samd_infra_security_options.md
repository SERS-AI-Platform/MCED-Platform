...
- 관련 문서: [[samd_db_scope]] (docs/architecture/samd_db_scope.md) — 개발 8단계와 DB 스키마 정의
...
![SOLUM SaMD 레이어 구조](../assets/images/samd_layered_architecture.png)
...
![Option A 앱 구조 매핑](../assets/images/pipeline_option_a.png)
...
![Option B 앱 구조 매핑](../assets/images/pipeline_option_b.png)
...
![Option C 앱 구조 매핑](../assets/images/pipeline_option_c.png)
