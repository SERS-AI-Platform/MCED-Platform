...
| Requirements traceability | User requirements, risks, evaluation tasks, evidence links | [clinical_use/TRACEABILITY_MATRIX.md](../clinical_use/TRACEABILITY_MATRIX.md), [sharepoint_sw_product](../sharepoint_sw_product/) | Draft working set | Link requirements to software versions, test evidence, and approved IFU copy |
...
| Model development control | Training workflow, model artifact provenance, validation scope, model-release criteria | [MODEL_WORKFLOW.md](../MODEL_WORKFLOW.md), `scripts/training/`, `artifacts/`, coverage/process gates | Partial | Add locked model-release checklist and artifact sign-off record |
| Software product control | Clinical app workflow, IFU linkage, packaging/deployment source | `scripts/deployment/`, [sharepoint_sw_product](../sharepoint_sw_product/), [clinical_use](../clinical_use/) | Draft working set | Add deployment test lane, build reproducibility evidence, software version policy |
