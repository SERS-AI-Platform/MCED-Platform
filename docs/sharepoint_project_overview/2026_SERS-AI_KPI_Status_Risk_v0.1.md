...
| --- | --- | ---: | --- |
| 5-cancer detection | SERS-only Det AUC | 0.977 +/- 0.005 | `docs/EXPERIMENT_CONTEXT.md`, Phase P |
| 5-cancer detection | Fusion Det AUC | 0.986 +/- 0.004 | `docs/EXPERIMENT_CONTEXT.md`, Phase P |
| 5-cancer detection | SERS-only sensitivity | 0.926 +/- 0.004 | `docs/EXPERIMENT_CONTEXT.md`, Phase P |
| 5-cancer detection | Fusion sensitivity | 0.939 +/- 0.011 | `docs/EXPERIMENT_CONTEXT.md`, Phase P |
| 5-cancer detection | SERS-only specificity | 0.929 +/- 0.019 | `docs/EXPERIMENT_CONTEXT.md`, Phase P |
| 5-cancer detection | Fusion specificity | 0.949 +/- 0.019 | `docs/EXPERIMENT_CONTEXT.md`, Phase P |
| 5-cancer type ID | SERS + sex constraint F1 macro | 0.892 +/- 0.026 | `docs/EXPERIMENT_CONTEXT.md`, Phase Q |
| 7-cancer detection | Fusion Det AUC | 0.979 +/- 0.005 | `docs/experiment.md`, Phase W |
| 7-cancer type ID | Fusion Type ID F1 | 0.923 +/- 0.022 | `docs/experiment.md`, Phase W |
